...
@router.get("/scans/{scan_id}/volta-debug")
async def get_volta_debug(scan_id: int, db: AsyncSession = Depends(get_db)):
    """Get Hough debug lines from volta detection for visualization."""
    import json
